...
namespace DogTest
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(puppy.GetTag()); // output: If lost, call Austin. His name is Dogie and he is 1 year old.

            Dog myDog =new Dog("Lileu", "Dale", 4, Gender.Female); // create object instance
            myDog.Bark(1); // output: Woof!
            Console.WriteLine(myDog.GetTag()); // output: If lost, call BillNye. Her name is Lileu and she is 4 years old.
        }
    }
}
